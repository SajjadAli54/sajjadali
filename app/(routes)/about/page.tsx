      ...
      <Row className="justify-content-center mb-5">
        <Col md={8} className="text-center">
          ...
          <p className="lead">
            ...
            building “just for fun” prototypes, I’ve been driven by a relentless
            curiosity and a passion for learning new things. I thrive when I can
            turn complex requirements into intuitive, reliable software.
          </p>
        </Col>
      </Row>
          ...
          <Card className="shadow-sm border-0 h-100">
            <Card.Body>
              ...
              <Card.Text>
                ...
                robust back‑end services for clients across Saudi Arabia,
                Kuwait, UAE, and Qatar. My day‑to‑day toolbox includes Python,
          ...
          <Card className="shadow-sm border-0 h-100">
            <Card.Body>
              ...
              <Card.Text>
                ...
                bring humility, humor, and a hacker’s spirit to every challenge.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
